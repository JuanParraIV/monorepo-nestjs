...
interface EnvVars {
  ...
  TCP_PRODUCTS_MICROSERVICE_PORT: number;
	TCP_ORDERS_MICROSERVICE_HOST: string;
  TCP_ORDERS_MICROSERVICE_PORT: number;
...
const envsSchema = Joi.object({
  ...
  TCP_ORDERS_MICROSERVICE_HOST: Joi.string().required(),
  TCP_ORDERS_MICROSERVICE_PORT: Joi.number().required(),
}).unknown(true);
...
const envVars: EnvVars = {
  ...
  TCP_ORDERS_MICROSERVICE_HOST: value.TCP_ORDERS_MICROSERVICE_HOST,
  TCP_ORDERS_MICROSERVICE_PORT: value.TCP_ORDERS_MICROSERVICE_PORT,
};
...
export const envs = {
  ...
  TCPOrdersMicroserviceHost: envVars.TCP_ORDERS_MICROSERVICE_HOST,
  TCPOrdersMicroservicePort: envVars.TCP_ORDERS_MICROSERVICE_PORT,
};
